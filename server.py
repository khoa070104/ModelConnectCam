...
# Define your helper functions and other code here
def midpoints(p1, p2):
...
async def process_frame(websocket, path):
    global frame, frame_shape, emotion, old_emotion, emotion_duration, distraction_duration
    ...
    async for message in websocket:
        ...
        if results.multi_face_landmarks:
            for landmarks in results.multi_face_landmarks:
                ...
                if not emotion and emotion_duration >= 20:
